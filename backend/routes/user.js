...
const fs = require('fs');
const { getAllProuct, tshirt, hoodies, stickers, mugs, updateUserPassword, findDetails, updateProfile, addCartProduct, getUsercart, updateCart} = require('../controllers/userControl');
