...
router.post('/updateadminprofile/:id',validation("user"),updateAdminProfile)
router.post('/updatepassword/:id',updateAdminPassword)
router.get('/getalluser',getAllUser)
router.get('/getId/:id',getId)
router.post('/adduser',validation("user"),addUser)
router.patch('/updateuser/:id',validation("user"),updateUser)
router.delete('/deleteuser/:id',deleteUser)
router.get('/getallproduct',getAllProuct)
router.get('/getproductid/:id',getproductID)
router.post('/addproduct',upload.single("productUrl"),validation("product"),addProduct)
router.patch('/updateproduct/:id',upload.single("productUrl"),validation("product"),updateProduct)
