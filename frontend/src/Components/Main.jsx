    ...
    return (
        <>
            ...
            <div className='d-flex  gap-3 align-self-center p-3 justify-content-between'>
                <button className={`cursor-pointer primary-btn tabBtn  px-5 py-2 rounded w-100 active-tab`} onClick={(e) => { tabView(0) }} >Signup</button>
                <button className={`cursor-pointer primary-btn tabBtn  px-5 py-2 rounded w-100 `} onClick={(e) => { tabView(1) }}>Login</button>
            </div>
            <div className={`tab`} >
